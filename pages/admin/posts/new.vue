<template>
  <div class="w-full max-w-4xl mx-auto px-4 md:px-6 py-12">
    <div class="mb-8">
      ...
      <h1 class="text-4xl font-bold text-gray-900">Criar Novo Artigo</h1>
      <p class="text-gray-600 mt-2">Preencha os campos abaixo para publicar um novo artigo no DevBlog</p>
    </div>
    <AdminPostForm />
  </div>
</template>
